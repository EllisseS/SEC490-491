...
if "messages" not in st.session_state.keys(): # Initialize the chat messages history
    st.session_state.messages = [
        {"role": "assistant", "content": "Refresh the page for every file that is imported" }
    ]
...
with st.sidebar:
    ...
    if data_file is not None:
        ...
        save_directory = "/home/ellisse/Desktop/Github/SEC490-491/capstoneProj/app/inspectData"
    ...
    folder_path= '/home/ellisse/Desktop/Github/SEC490-491/capstoneProj/app/inspectData'
...
input_dir = '/home/ellisse/Desktop/Github/SEC490-491/capstoneProj/app/inspectData'
